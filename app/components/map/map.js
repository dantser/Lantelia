...
export default () => {
  ...
  markers["marker2"] = L.marker([60.010829, 30.402103], {icon: moulinRouge}, {title: marker2}).addTo(mymap).bindPopup(L.popup({maxWidth:201}).setContent("<h3>Мулен Руж</h3> <p>г. Санкт-Петербург, просп. Науки, 23а</p><h3>Контакты</h3> <p>Тел.: 79269464613<br>Эл. почта: msk.bel@cdek.ru</p> <p>Пн-Пт – с 10:00 до 20:00<br>Сб, Вс – с 10:00 до 16:00</p>")).on('click', clickZoom);

  var petrPassage = new LeafIcon({iconUrl: 'assets/images/pin.svg'});
  markers["marker3"] = L.marker([57.817232, 28.314583], {icon: petrPassage}, {title: marker3}).addTo(mymap).bindPopup(L.popup({maxWidth:201}).setContent("<h3>Петровский Пассаж</h3> <p>г. Псков, Рижский пр-кт, д.16</p><h3>Контакты</h3> <p>Тел.: 79269464613<br>Эл. почта: msk.bel@cdek.ru</p> <p>Пн-Пт – с 10:00 до 20:00<br>Сб, Вс – с 10:00 до 16:00</p>")).on('click', clickZoom);

  var iconFour = new LeafIcon({iconUrl: 'assets/images/pin.svg'});
  markers["marker4"] = L.marker([57.817232, 28.314583], {icon: iconFour}, {title: marker4}).addTo(mymap).bindPopup(L.popup({maxWidth:201}).setContent("<h3>Петровский Пассаж</h3> <p>г. Псков, Рижский пр-кт, д.16</p><h3>Контакты</h3> <p>Тел.: 79269464613<br>Эл. почта: msk.bel@cdek.ru</p> <p>Пн-Пт – с 10:00 до 20:00<br>Сб, Вс – с 10:00 до 16:00</p>")).on('click', clickZoom);

  var iconFive = new LeafIcon({iconUrl: 'assets/images/pin.svg'});
  markers["marker5"] = L.marker([57.817232, 28.314583], {icon: iconFive}, {title: marker5}).addTo(mymap).bindPopup(L.popup({maxWidth:201}).setContent("<h3>Петровский Пассаж</h3> <p>г. Псков, Рижский пр-кт, д.16</p><h3>Контакты</h3> <p>Тел.: 79269464613<br>Эл. почта: msk.bel@cdek.ru</p> <p>Пн-Пт – с 10:00 до 20:00<br>Сб, Вс – с 10:00 до 16:00</p>")).on('click', clickZoom);
